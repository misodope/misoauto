      ...
      <Box p="6" flexGrow="1" style={{ maxWidth: 800, margin: '0 auto' }}>
        <Flex direction="column" gap="5">
          ...
          <Section title="Introduction">
            <Text as="p">
              These Terms of Service govern your use of MisoAuto. By using our
              app or website, you agree to these Terms of Service.
            </Text>
          </Section>

          <Section title="SMS Messaging and Communications">
            <Text as="p" mb="3">
              By using MisoAuto, you automatically opt-in to receive SMS
              messages and other communications related to our services. These
          ...
          <Section title="Disclaimer of Warranties">
            <Text as="p">
              Our app or website is provided on an &quot;as is&quot; and
              &quot;as available&quot; basis. We make no representations or
              warranties of any kind, express or implied, as to the operation of
              our app or website or the information, content, materials, or
              products included on our app or website.
            </Text>
          </Section>
          ...
          <Section title="Indemnification">
            <Text as="p">
              ...
              reasonable attorneys&apos; fees) arising from your use of our app
              or website or your breach of these Terms of Service.
            </Text>
          </Section>
