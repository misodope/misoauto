...
export default function UploadVideo() {
  ...
  const handleCaptionChange = (platform: keyof FormData['platforms'], caption: string) => {
    setFormData(prev => ({
      ...prev,
      platforms: {
        ...prev.platforms,
    ...
    <Box p="6">
        ...
        <Flex direction="column" gap="4">
          ...
          <Box
            ...
            style={{
              ...
              backgroundColor: formData.file ? 'var(--accent-2)' : 'var(--gray-2)'
            }}
          >
            <Flex direction="column" align="center" gap="3">
              ...
              {formData.file ? (
                ...
                <>
                  <Text size="4" weight="medium">Click to select a video file</Text>
                  <Text size="2" color="gray">
            ...
            <Card key={key} size="3" style={{ width: '500px' }}>
              <Flex direction="column" gap="4">
                ...
                <Switch
                  ...
                  onCheckedChange={() => handlePlatformToggle(key as keyof FormData['platforms'])}
                />
              </Flex>
                ...
                <>
                  ...
                  <Box style={{ width: '100%' }}>
                    ...
                    <TextArea
                      ...
                      onChange={(e: any) =>
                        handleCaptionChange(key as keyof FormData['platforms'], e.target.value)
                      }
                      rows={3}
                      style={{ width: '100%' }}
                    />
      ...
      <Flex justify="end" gap="3" mt="8">
        ...
        <Button
          ...
          disabled={!formData.file || !Object.values(formData.platforms).some(p => p.enabled)}
        >
          Upload Video
        </Button>
      </Flex>
